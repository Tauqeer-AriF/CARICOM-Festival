...
export const GalleryView: React.FC<GalleryViewProps> = ({ setActiveTab, galleryItems = [] }) => {
  ...
  const activeItems = galleryItems.length > 0 ? galleryItems : GALLERY_ITEMS;
  ...
  return (
    <div className="space-y-10 animate-fadeIn">
          ...
          return (
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-semibold uppercase tracking-wider transition-all cursor-pointer ${
                isActive 
                  ? 'bg-amber-500 text-neutral-950 font-bold shadow-[0_4px_15px_rgba(212,175,55,0.3)] border border-amber-300/40 scale-105' 
      ...
      {/* Bottom CTA Banner */}
      <div className="p-8 rounded-3xl bg-gradient-to-r from-amber-500/10 via-neutral-900 to-amber-600/10 border border-amber-500/30 text-center space-y-4 max-w-4xl mx-auto shadow-2xl">

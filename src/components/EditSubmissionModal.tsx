          ...
          <div className="bg-neutral-950/60 border border-neutral-800/80 rounded-xl p-4 space-y-3">
            <div className="flex items-center justify-between border-b border-neutral-900 pb-2">
              ...
              <button
                ...
                className="px-2 py-1 bg-neutral-900 hover:bg-neutral-800 text-amber-400 text-[10px] font-bold rounded-lg border border-neutral-800 transition-colors flex items-center gap-1 cursor-pointer"
              >
            ...
            {showAddMeta && (
              <div className="p-3 bg-[#0C0F1E] border border-amber-500/30 rounded-xl space-y-2 animate-in fade-in">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <input
                    ...
                    className="bg-neutral-950 border border-neutral-800 rounded-lg px-2.5 py-1.5 text-xs text-white placeholder-neutral-600 focus:outline-none focus:border-amber-500"
                  />
                  <input
                    type="text"
                ...
                <div className="flex justify-end gap-2 pt-1">
                  <button
                    ...
                    className="px-2.5 py-1 bg-neutral-900 text-neutral-400 text-[10px] font-bold rounded hover:text-white cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="px-3 py-1 bg-amber-500 text-neutral-950 text-[10px] font-black rounded hover:bg-amber-400 disabled:opacity-40 cursor-pointer"
                  >
                    Add Parameter
                  </button>
                </div>
            ...
            {formData.extraDetails.length > 0 ? (
              <div className="space-y-2 max-h-[160px] overflow-y-auto pr-1">
                {formData.extraDetails.map((item, idx) => (
                  <div key={idx} className="flex items-center gap-2 bg-[#0C0F1E] border border-neutral-850 p-2 rounded-lg">
                    <input
                      type="text"
                      placeholder="Field Name"
                      value={item.key}
                      onChange={(e) => handleExtraDetailChange(idx, 'key', e.target.value)}
                      className="w-1/3 bg-neutral-950 border border-neutral-800 rounded px-2 py-1 text-xs text-amber-300 font-mono focus:outline-none focus:border-amber-500"
                    />
                    ...
                    <input
                      ...
                      className="flex-1 bg-neutral-950 border border-neutral-800 rounded px-2 py-1 text-xs text-white focus:outline-none focus:border-amber-500"
                    />
                    <button
                      type="button"
                      onClick={() => handleRemoveExtraDetail(idx)}
                      className="p-1 text-neutral-500 hover:text-rose-400 transition-colors cursor-pointer rounded hover:bg-rose-500/10"
                      title="Remove field"
                    >
